...
\begin{tabularx}{\linewidth}{@{}m{0.75\textwidth} m{0\textwidth}@{}}
{
    ...
    %     Undergraduate\newline
    % \end{align}
    %\href{https://tinyurl.com/535xj5x8}{Helgenæsgade 7, 3. th., 8000 Aarhus C}\newline
        \clink{
...
\csection{Competitive Programming}{\small
    \begin{itemize}
        ...
        Won the danish championship in programming for university students.
        \item \textbf{Northwestern Europe Regional Contest\hfill(2020-2024)}\newline
        Qualified for the team representing Aarhus University 5 times and won gold medal in 2024.
        ...
        Qualified for the danish team and won bronze medal.
    \end{itemize}
}
