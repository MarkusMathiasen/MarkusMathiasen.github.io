...
\csection{Education}{\small
    \begin{itemize}
        ...
        \textit{Description:} In this project, I looked at known results about how to decide whether a graph is connected or not in the semi-streaming model. I also looked at what we can do if we want the algorithm to be robust against an adaptive adversary.
    \end{itemize}
}

\csection{Publications}{\small
    \begin{itemize}
        \item \textbf{\href{https://arxiv.org/abs/2602.19552}{The Sample Complexity of Replicable Realizable PAC Learning}\hfill(2026)}\\
        \textit{With:} Kasper Green Larsen, Chirag Pabbaraju and Clement Svendsen\\
        \textit{Conference:} ACM Symposium on Theory of Computing (STOC 2026)
        
        \item \textbf{\href{https://arxiv.org/abs/2501.18388}{Improved Replicable Boosting with Majority-of-Majorities}\hfill(2026)}\\
        \textit{With:} Kasper Green Larsen and Clement Svendsen\\
        \textit{Conference:} Algorithmic Learning Theory (ALT 2026)
        
        \item \textbf{\href{https://arxiv.org/abs/2408.17148}{The Many Faces of Optimal Weak-to-Strong Learning}\hfill(2024)}\\
        \textit{With:} Mikael Møller Høgsgaard and Kasper Green Larsen\\
        \textit{Conference:} Neural Information Processing Systems (NeurIPS 2024)
    \end{itemize}
}
\newpage
\csection{Teaching Experience}{\small
    \begin{itemize}
        \item \textbf{Teaching Assistant\hfill(2021-2025)}\newline
        ...
        \begin{itemize}
            ...
            \item Programming Café\hfill(4 semesters)
